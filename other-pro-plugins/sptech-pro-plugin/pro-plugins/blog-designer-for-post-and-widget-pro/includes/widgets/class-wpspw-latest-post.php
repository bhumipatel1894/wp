...
class Wpspw_Pro_Lpw_Widget extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array('classname' => 'wpspw_pro_post_simple_widget', 'description' => __('Display Latest WP Post in a sidebar.', 'blog-designer-for-post-and-widget') );
        parent::__construct( 'wpspw-pro-lpw-widget', __('Latest WP Post Widget', 'blog-designer-for-post-and-widget'), $widget_ops);
    }

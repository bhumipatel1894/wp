	...
	<div class="wpspw-post-list-content">
		...
		<?php if ( !empty($feat_image) ) { ?>
			...
			<div class="wpspw-medium-4 wpspw-columns">
				...
				<div class="wpspw-slideline">

					<hr>
				</div><!-- end .wpspw-slideline -->
			</div><!-- end .wpspw-columns -->
		<?php } ?>

		<div class="<?php if ( empty($feat_image) ) { echo 'wpspw-medium-12 wpspw-columns'; } else { echo 'wpspw-medium-8 wpspw-columns'; } ?>">

	...
	<div class="wpspw-post-grid wpspw-medium-<?php echo $post_grid; ?> wpspw-columns <?php echo $css_class; ?>">
		<div class="wpspw-post-grid-content">
			...
			<div class="wpspw-post-detail-wrap">
				...
				<?php } ?>
			</div><!-- end .wpspw-post-detail-wrap -->
		</div><!-- end .wpspw-post-grid-content -->
	</div><!-- end .wpspw-post-grid -->
<?php } else { ?>
	<div class="wpspw-post-grid wpspw-medium-<?php echo $post_grid; ?> wpspw-columns <?php echo $css_class; ?>">
		<div class="wpspw-post-grid-content" style="padding:15px 0 0 0;">	
			<div class="wpspw-post-detail-wrap">
				<?php if($showDate == "true" || $showAuthor == 'true' || $show_comments =="true") { ?>
					<div class="wpspw-post-date">
						<?php if($showAuthor == 'true') { ?>
				...
				<?php } ?>
			</div><!-- end .wpswp-post-detail-wrap  -->
			<div class="wpspw-post-image-bg" style="margin-bottom:0px;<?php echo $height_css; ?>">
				<?php if( !empty($feat_image) ) { ?>
					<img src="<?php echo $feat_image; ?>" alt="<?php the_title(); ?>" />
				<?php } ?>
				<div class="wpspw-image-overlay">

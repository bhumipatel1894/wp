<?php $featured_medium_image = wpspw_pro_get_post_featured_image( $post->ID, 'large',true );  ?>
<div class="wpspw-post-grid wpspw-medium-12 wpspw-columns <?php echo $css_class; ?>">
	<div class="wpspw-medium-4 wpspw-columns">
		...
		<?php } ?>
	</div><!-- end .wpspw-medium-8\4 -->
	<div class="wpspw-medium-8 wpspw-columns">
		<?php if ( $featured_medium_image ) { ?>

...
$dynamic_class 	= ($grid_count == 1) ? 'wpspw-medium-8' : 'wpspw-medium-4';
?>

<div class="wpspw-post-slides wpspw-clr-<?php echo $grid_count; ?> <?php echo $dynamic_class; ?> wpspw-columns">
...
<?php if( $grid_count == 3 || ( $post_count == $count ) ) {
	$grid_count = 0;
} ?>
...
<div class="wpcdt-clock">
	<?php if($is_days == 1){ ?>
		<div class="ce-col">
			<span class="ce-days wpcdt-color"></span><i>:</i><span class="ce-days-label"></span>
		</div>
	<?php } ?>
	
	<?php if($is_hours == 1){ ?>
		<div class="ce-col">
			<span class="ce-hours wpcdt-color"></span><i>:</i><span class="ce-hours-label"></span>
		</div>
	<?php } ?>
	
	<?php if($is_minutes == 1){ ?>
		<div class="ce-col">
			<span class="ce-minutes wpcdt-color"></span><i>:</i><span class="ce-minutes-label"></span>
		</div>
	<?php } ?>

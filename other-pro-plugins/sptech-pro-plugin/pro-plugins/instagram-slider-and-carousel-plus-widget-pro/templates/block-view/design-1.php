...
switch ($grid_count) {
	case '2':
	$dynamic_cls = 'iscwp-block-6';
	break;

	case '4':
	case '5':
	case '6':
	$dynamic_cls = 'iscwp-block-4';
	break;

	default:
	$dynamic_cls = 'iscwp-block-3';
	break;
}
$height_css = !empty($gallery_height) ? "height:{$gallery_height}px;" : '';
$main_cls 	= "iscwp-cnt-wrp iscwp-bglay-{$grid_count} iscwp-block-columns {$dynamic_cls}"; ?>

<div class="<?php echo $main_cls; ?>">

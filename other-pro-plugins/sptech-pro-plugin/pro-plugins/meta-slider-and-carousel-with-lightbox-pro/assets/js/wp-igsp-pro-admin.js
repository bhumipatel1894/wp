jQuery( document ).ready(function( $ ) {
	...
	$( document ).on( 'click', '.wp-igsp-img-uploader', function() {
		...
		if( typeof wp == "undefined" || WpIgspProAdmin.new_ui != '1' ) { // check for media uploader
						...
						showfield.append('\
							<div class="wp-igsp-img-wrp">\
								<div class="wp-igsp-img-tools wp-igsp-hide">\
									<span class="wp-igsp-tool-icon wp-igsp-edit-img dashicons dashicons-edit" title="'+WpIgspProAdmin.img_edit_popup_text+'"></span>\
									<a href="'+attachment_edit_link+'" target="_blank" title="'+WpIgspProAdmin.attachment_edit_text+'"><span class="wp-igsp-tool-icon wp-igsp-edit-attachment dashicons dashicons-visibility"></span></a>\
									<span class="wp-igsp-tool-icon wp-igsp-del-tool wp-igsp-del-img dashicons dashicons-no" title="'+WpIgspProAdmin.img_delete_text+'"></span>\
								</div>\
	...
	$(document).on('click', '.wp-igsp-del-gallery-imgs', function() {
		...
		var ans = confirm(WpIgspProAdmin.all_img_delete_text);
	...
	$(document).on('click', '.wp-igsp-img-wrp .wp-igsp-edit-img', function(){
		...
		var data = {
                        action      	: 'wp_igsp_pro_get_attachment_edit_form',
	...
	$(document).on('click', '.wp-igsp-save-attachment-data', function(){
		...
		var data = {
                        action      	: 'wp_igsp_pro_save_attachment_data',

	...
	<form method="post" class="wp-igsp-attachment-form">
		...
		<table class="form-table">
			<tr>
				...
				<td>
					<input type="text" name="wp_igsp_attachment_title" value="<?php echo wp_igsp_pro_esc_attr($attachment_post->post_title); ?>" class="large-text wp-igsp-attachment-title" id="wp-igsp-attachment-title" />
			...
			<tr>
				...
				<td>
					<input type="text" name="wp_igsp_attachment_alt" value="<?php echo wp_igsp_pro_esc_attr($alt_text); ?>" class="large-text wp-igsp-attachment-alt-text" id="wp-igsp-attachment-alt-text" />
			...
			<tr>
				...
				<td>
					<textarea name="wp_igsp_attachment_caption" class="large-text wp-igsp-attachment-caption" id="wp-igsp-attachment-caption"><?php echo wp_igsp_pro_esc_attr($attachment_post->post_excerpt); ?></textarea>
			...
			<tr>
				...
				<td>
					<textarea name="wp_igsp_attachment_desc" class="large-text wp-igsp-attachment-desc" id="wp-igsp-attachment-desc"><?php echo wp_igsp_pro_esc_attr($attachment_post->post_content); ?></textarea>

...
<div class="wp-igsp-img-data-wrp wp-igsp-hide">
	<div class="wp-igsp-img-data-cnt">
		...
		<div class="wp-igsp-img-cnt-block">
			<div class="wp-igsp-popup-close wp-igsp-popup-close-wrp"><img src="<?php echo WP_IGSP_PRO_URL; ?>assets/images/close.png" alt="<?php _e('Close (Esc)', 'meta-slider-and-carousel-with-lightbox'); ?>" title="<?php _e('Close (Esc)', 'meta-slider-and-carousel-with-lightbox'); ?>" /></div>

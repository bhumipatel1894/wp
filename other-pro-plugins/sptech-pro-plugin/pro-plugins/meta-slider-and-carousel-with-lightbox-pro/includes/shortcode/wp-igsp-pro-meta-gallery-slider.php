...
function msacwl_pro_gallery_slider($atts, $content) {
	...
	<div class="msacwl-slider-wrap msacwl-row-clearfix">
		<div id="msacwl-slider-<?php echo $unique; ?>" class="msacwl-slider <?php echo $wrapper_cls; ?>" <?php echo $slider_as_nav_for; ?>>
			...
			<div class="msacwl-slider-conf"><?php echo htmlspecialchars(json_encode($slider_conf)); ?></div>
		</div>
		<?php 		// For Navigation design 
		if( $navigation == 'true' ) { ?>
...
// 'meta_gallery_slider' Shortcode
add_shortcode( 'meta_gallery_slider', 'msacwl_pro_gallery_slider' );
<div class="msacwl-slide" data-item-index="<?php echo $count; ?>">
	...
	<div class="msacwl-gallery-container">
		<div class="msacwl-gallery-container-wrap">

			<?php if($show_title == 'true') { ?>
			<div class="msacwl-image-title">
				<?php echo $post_meta_data->post_title; ?>
			</div>
			<?php } if( $image_caption != '' || $image_content != '') { ?>

			<div class="msacwl-caption-desc-wrapper">
				<?php if($show_caption == 'true' && $image_caption != '') { ?>
				<div class="msacwl-image-caption">
					<?php echo $image_caption; ?>
				</div>
				<?php } if($show_description == 'true' && $image_content != '') { ?>

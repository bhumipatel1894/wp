...
function wprpsp_post_carousel( $atts, $content = null ){
	...
	// Shortcode file
	$design_file_path 	= WPRPSP_DIR . '/templates/carousel/' . $design . '.php';
	...
	if ( $query->have_posts() ) : ?>
		...
		<div class="wprpsp-carousel-pro-slider-wrp wprpsp-clearfix">
			<div id="wprpsp-recent-post-carousel-<?php echo $unique; ?>" class="wprpsp-recent-post-carousel slides-to-show-<?php echo $slides_to_show.' '.$slider_cls; ?> wprpsp-clearfix">

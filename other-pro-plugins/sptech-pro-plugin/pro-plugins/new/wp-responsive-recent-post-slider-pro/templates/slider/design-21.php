<?php
	$featured_img_medium = wprpsp_get_post_featured_image( $post_id, 'medium', true );
?>
<div class="wprpsp-post-slides">
	<div class="wprpsp-post-cnt-pos wprpsp-clearfix">

		<div class="wprpsp-medium-4 wprpsp-columns">
		...
		<div class="wprpsp-medium-8 wprpsp-columns">
			<?php if( !empty($featured_img_medium) ) { ?>
			<div class="wprpsp-post-image-wrap wprpsp-post-image-bg">
				<a href="<?php echo $post_link; ?>" target="<?php echo $link_target; ?>">
					<img src="<?php echo $featured_img_medium; ?>" alt="<?php _e('Post Image', 'wp-responsive-recent-post-slider'); ?>" />
				</a>
			</div>
			<?php } ?>

	...
	<form method="post" class="wp-pap-attachment-form">
		...
		<table class="form-table">
			<tr>
				...
				<td>
					<input type="text" name="wp_pap_attachment_title" value="<?php echo wp_pap_pro_esc_attr($attachment_post->post_title); ?>" class="large-text wp-pap-attachment-title" id="wp-pap-attachment-title" />
			...
			<tr>
				...
				<td>
					<input type="text" name="wp_pap_attachment_alt" value="<?php echo wp_pap_pro_esc_attr($alt_text); ?>" class="large-text wp-pap-attachment-alt-text" id="wp-pap-attachment-alt-text" />

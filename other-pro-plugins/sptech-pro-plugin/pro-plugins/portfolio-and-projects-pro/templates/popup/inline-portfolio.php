<div class="wppap-portfolio-content">
	...
	<?php while ($query->have_posts()) : $query->the_post();
			...
			$right_cnt_wrp_cls		= !empty($gallery_imgs) ? 'wppap-medium-6' : 'wppap-medium-12';
			$cat_links 				= array();
			$tag_links 				= array();
		...
		<div id="wppap-popup-<?php echo $unique_thumb; ?>">
			<?php if( !empty($gallery_imgs) ) { ?>
			<div class="wppap-medium-6 wppap-columns">
				<div class="wppap-slider-wrapper">
					<div id="wppap-slider-<?php echo $unique_thumb; ?>" class="wpapap-portfolio-img-slider wppap-img-grp">
						<?php foreach ($gallery_imgs as $img_key => $img_data) {

							$gallery_img_src 	= wp_pap_pro_get_image_src( $img_data );
			...
			<div class="<?php echo $right_cnt_wrp_cls; ?> wppap-columns">
				<div class="wppap-right-content">

					<div class="wppap-title"><?php the_title(); ?></div>
					...
					<table class="wppap-portfolio-meta-tbl">
						<tbody>
							...
							<tr>
								...
								<td>
									<div class="wppap-popup-cats"><?php echo $cate_name; ?></div>
								</td>
							</tr>
							<?php } ?>
							...
							<tr>
								...
								<td>
									<div class="wppap-popup-tags"><?php echo $tag_name; ?></div>
								</td>
							</tr>
							<?php } ?>

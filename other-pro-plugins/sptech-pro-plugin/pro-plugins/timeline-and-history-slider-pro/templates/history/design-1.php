<div class="wphtsp-timeline-block">
    ...
    <div class="wphtsp-timeline-content <?php if($i != 1 && $animation != 'no-animation'){ echo 'wphtsp-is-hidden'; } ?>" <?php echo $background_style; ?>>
        ...
        <div class="wphtsp-post-date" <?php echo $font_style; ?>>
            <i class="fa fa-calendar"></i> <?php echo get_the_date($date_format); ?>
        </div>
        <?php } ?>
        ...
        <div class="wphtsp-content">
            ...
            <div class="wphtsp-content-inner" <?php echo $font_style; ?>>
            ...
            <div class="wphtsp-fullcontent" <?php echo $font_style; ?>>
                <?php the_content(); ?>
            </div>
    ...
    <div class="wphtsp-timeline-img <?php if($i != 1 && $animation != 'no-animation') { echo 'wphtsp-is-hidden'; } if(!empty($tl_cust_icon)){echo " wphtsp-custom-icon";} ?>">

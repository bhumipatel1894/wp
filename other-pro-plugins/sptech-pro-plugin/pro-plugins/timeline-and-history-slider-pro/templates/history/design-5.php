<div class="wphtsp-timeline-block">
    ...
    <div class="wphtsp-timeline-content <?php if($i != 1 && $animation != 'no-animation'){ echo 'wphtsp-is-hidden'; } ?>" <?php echo $background_style; ?>>
        <div class="wphtsp-title-wrapper">
            
            <?php if( $show_title ) { ?>
            <h2 class="wphtsp-content-title">
                <?php if( $link ) { ?>
                <a href="<?php echo $post_link; ?>" target="<?php echo $link_target; ?>" <?php echo $font_style; ?>><span><?php the_title(); ?></span></a>
                <?php } else { ?>
    ...
    <div class="wphtsp-content-wrapper <?php if(empty($feat_image)){ echo 'wphtsp-no-image'; } ?>">
        <div class="wphtsp-image-wrapper">

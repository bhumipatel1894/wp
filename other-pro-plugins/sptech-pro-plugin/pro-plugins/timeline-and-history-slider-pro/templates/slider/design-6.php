<div id="wphtsp-slider-nav-<?php echo $unique; ?>" class="wphtsp-slider-nav-<?php echo $unique; ?> wphtsp-slider-nav wphtsp-slick-slider" <?php echo $slider_as_nav_for; ?>>
	<?php while ( $query->have_posts() ) : $query->the_post();  ?>
		<div class="wphtsp-slider-nav-title">
			<div class="wphtsp-title"><span><?php echo the_title(); ?></span></div>
					...
					<div class="wphtsp-content-wrapper <?php if(empty($feat_image)) { echo 'wphtsp-no-image';} ?>">
						...
						<div class="wphtsp-content">
							<?php if($showFullContent == "false" ) { ?>
								...
								<div class="wphtsp-fullcontent wphtsp-tl-content" <?php echo $font_style; ?>><?php the_content(); ?></div>
							<?php } ?>
						</div>
						<?php } ?>
					</div>

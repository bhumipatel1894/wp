...
function wcpscwc_pro_products_slider( $atts, $content ) {
...
// 'products_slider' shortcode
add_shortcode( 'products_slider', 'wcpscwc_pro_products_slider' ); // Older shortcode
add_shortcode( 'wcpscwc_pdt_slider', 'wcpscwc_pro_products_slider' );
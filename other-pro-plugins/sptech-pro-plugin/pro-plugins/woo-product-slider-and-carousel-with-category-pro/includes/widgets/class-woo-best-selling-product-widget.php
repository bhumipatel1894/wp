...
/**
 * Widget API: WPOS WooCommerce Best Selling Products Widget
 *
...
function wpscwcp_woo_best_selling_products_widget() {
    register_widget( 'Wpscwcp_Best_Selling_Product_Widget' );
}

// Action to register widget
add_action( 'widgets_init', 'wpscwcp_woo_best_selling_products_widget' );

class Wpscwcp_Best_Selling_Product_Widget extends WP_Widget {
    ...
    */
    function __construct() {
        ...
        $widget_ops = array('classname' => 'wpscwcp-best-selling-pdt-widget', 'description' => __('Display Best Selling WooCommerce Products in Grid/Slider.', 'woo-product-slider-and-carousel-with-category'));
        parent::__construct( 'wpscwcp_best_selling_product_widget', __('WPOS - WC Best Selling Products', 'woo-product-slider-and-carousel-with-category'), $widget_ops );

        $this->defaults = array(
            'title'             => __( 'Best Selling Products', 'woo-product-slider-and-carousel-with-category' ),
            'cat'               => '',
            'design'            => 'design-1',
    ...
    */
    ...
    ?>
        ...
        <!-- Design -->
        <p>
            <label for="<?php echo $this->get_field_id( 'design' ); ?>"><?php _e( 'Design:', 'news' ); ?></label>
        ...
        */ ?>
        ...
        <!-- Widget Autoplay: Select Auto play -->
        <p>
    ...
    */
    function widget($news_args, $instance) {
        ...
        $title              = apply_filters( 'widget_title', isset( $instance['title'] ) ? $instance['title'] : __( 'Best Selling Products', 'woo-product-slider-and-carousel-with-category' ), $instance, $this->id_base );
        $cat                = $instance['cat'];

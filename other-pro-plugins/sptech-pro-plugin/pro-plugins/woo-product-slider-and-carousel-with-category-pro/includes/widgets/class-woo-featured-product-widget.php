<?php
/**
 * Widget API: WPOS WooCommerce Featured Products Grid/Slider Widget
 *
...
function wpscwcp_woo_featured_product_widget() {
    register_widget( 'Wpscwcp_Featured_Product_Widget' );
}

// Action to register widget
add_action( 'widgets_init', 'wpscwcp_woo_featured_product_widget' );

class Wpscwcp_Featured_Product_Widget extends WP_Widget {
    ...
    */
    function __construct() {
        ...
        $widget_ops = array('classname' => 'wpscwcp-woo-featured-pdt-widget', 'description' => __('Display WooCommerce Featured Products in Grid/Slider.', 'woo-product-slider-and-carousel-with-category'));
        parent::__construct( 'wpscwcp_woo_featured_product_Widget', __('WPOS - WC Featured Products', 'woo-product-slider-and-carousel-with-category'), $widget_ops );

        $this->defaults = array(
            'title'             => __( 'Featured Products', 'woo-product-slider-and-carousel-with-category' ),
            'cat'               => 0,
            'design'            => 'design-1',
    ...
    */
    function widget($news_args, $instance) {
        ...
        $title              = apply_filters( 'widget_title', isset( $instance['title'] ) ? $instance['title'] : __( 'Featured Products', 'woo-product-slider-and-carousel-with-category' ), $instance, $this->id_base );
        $cat                = $instance['cat'];

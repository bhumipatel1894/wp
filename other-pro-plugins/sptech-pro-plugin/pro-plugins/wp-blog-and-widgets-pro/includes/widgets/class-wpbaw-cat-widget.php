<?php
/**
 * Widget API: Wpbaw_Widget_Blog_Categories class
 *
...
class Wpbaw_Widget_Blog_Categories extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$title = apply_filters( 'widget_title', isset($instance['title']) ? $instance['title'] : __( 'Blog Categories', 'wp-blog-and-widgets' ), $instance, $this->id_base );

<?php
/**
 * Widget API: Latest Blog List Slider 2 Widget Class
 *
...
function wpbaw_pro_latest_blog_list_slider2_widget() {
    register_widget( 'Wpbaw_Pro_Lblsw2_Widget' );
}

// Action to register widget
add_action( 'widgets_init', 'wpbaw_pro_latest_blog_list_slider2_widget' );


class Wpbaw_Pro_Lblsw2_Widget extends WP_Widget {
    ...
    function __construct() {
		...
		$widget_ops = array('classname' => 'wpbaw-pro-lblsw2', 'description' => __('Display Latest Blog Items in list view OR in Slider.', 'wp-blog-and-widgets') );
		parent::__construct( 'wpbaw_pro_lblsw2', __('Latest Blog List/Slider 2', 'wp-blog-and-widgets'), $widget_ops );
    }
    ...
    */
    function widget( $blog_args, $instance ) {
        ...
        $title                      = apply_filters( 'widget_title', isset( $instance['title'] ) ? $instance['title'] : __( 'Latest Blog List/Slider 2', 'wp-blog-and-widgets' ), $instance, $this->id_base );
        $num_items                  = $instance['num_items'];
        $date                       = ( isset($instance['date']) && (1 == $instance['date']) ) ? "true" : "false";
        $show_category              = ( isset($instance['show_category']) && (1 == $instance['show_category']) ) ? "true" : "false";
...
?>
        ...
        <div class="wpbaw-pro-blog-widget-wrp wpbaw-clearfix">
            <div class="sp_blog_static design-w3 <?php echo $slider_cls; ?> wpbaw-clearfix" id="wpbaw-pro-blog-widget-<?php echo $unique; ?>">

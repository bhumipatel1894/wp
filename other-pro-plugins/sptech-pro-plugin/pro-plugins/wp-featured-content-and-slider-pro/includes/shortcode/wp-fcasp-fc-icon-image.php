 ...
 * Shorecode File
 *
 * Handles the 'featured-cnt-icon-img' shortcode functionality of plugin
 *
...
/**
 * Shorecode 'featured-cnt-icon-img'
 *
 * @package WP Featured Content and Slider Pro
 * @since 1.0.0
 */
function wp_fcasp_fc_icon_img_shortcode( $atts, $content ) {
	
	// Shortcode Parameters
	extract(shortcode_atts(array(
		'type'					=> 'grid', // Determine it is a grid or slider
		'limit' 				=> '15',
		'grid' 					=> '12',
		'cat_id' 				=> '',
	...
	$shortcode_designs 		= wp_fcasp_fc_cnt_icon_img_designs();
...
// 'featured-cnt-icon-img' shortcode
add_shortcode('featured-cnt-icon-img', 'wp_fcasp_fc_icon_img_shortcode');
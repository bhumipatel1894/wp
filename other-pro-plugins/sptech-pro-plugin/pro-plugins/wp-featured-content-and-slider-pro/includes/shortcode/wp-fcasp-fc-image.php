 ...
 * Shorecode File
 *
 * Handles the 'featured-cnt-img' shortcode functionality of plugin
 *
...
/**
 * Shorecode 'featured-cnt-img'
 *
 * @package WP Featured Content and Slider Pro
 * @since 1.0.0
 */
function wp_fcasp_fc_image_shortcode( $atts, $content ) {
	...
	$shortcode_designs 		= wp_fcasp_fc_cnt_img_designs( $type );
	...
	$design 				= ($design && (array_key_exists(trim($design), $shortcode_designs))) ? trim($design) : 'design-8';
	...
	$words_limit 			= (!empty($content_words_limit))? $content_words_limit 	: '25';
...
// 'featured-cnt-img' shortcode
add_shortcode('featured-cnt-img', 'wp_fcasp_fc_image_shortcode');
<div class="featured-content-main <?php echo $css_class .' '. $grid_cls .' '. $slider_clmn_cls; ?>">
	<div class="featured-content-position">
		<div class="featured-content-overlay">
			...
			<?php if($sliderurl != '') { ?>
				<a href="<?php echo $sliderurl; ?>" target="<?php echo $link_target; ?>"><?php if($fc_icon != '') { echo '<i class="'.$fc_icon.'"></i>'; } ?></a>
			<?php } else { ?>
				<?php if($fc_icon != '') { echo '<i class="'.$fc_icon.'"></i>'; } ?>	
			<?php } ?>

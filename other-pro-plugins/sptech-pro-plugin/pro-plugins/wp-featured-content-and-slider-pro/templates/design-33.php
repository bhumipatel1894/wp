<div class="featured-content-main <?php echo $css_class; ?> <?php echo $grid_cls; ?>">
	<div class="featured-wraper text-left">
	...
	<div class="img-contain">
			<?php if($sliderurl != '') { ?>			
				...
				<?php } ?></a>
			<?php } else { ?>
				<?php if($fc_icon != '') { echo '<i style="color:'.$faIconcolor.'" class="fcasp-effect '.$fc_icon.'" aria-hidden="true"></i>'; } else { the_post_thumbnail(array(70,70)); } ?>
			<?php } ?>
		</div>

		...
		<div class="featured-content-image"> 
			<div class="fa-icon">
				<?php if($sliderurl != '') { ?>
					...
					<a href="<?php echo $sliderurl; ?>" target="<?php echo $link_target; ?>"><?php if($fc_icon != '') { echo '<i style="color:'.$faIconcolor.'" class="'.$fc_icon.'"></i>'; } else { the_post_thumbnail(array(60,60)); } ?></a>
					
				<?php } else { ?>

					<?php if($fc_icon != '') { echo '<i style="color:'.$faIconcolor.'" class="'.$fc_icon.'"></i>'; } else { the_post_thumbnail(array(60,60)); } ?>	

...
(function($){
	...
	$.fn.wposTicker = function(params){
			...
			return this.each(function(){
				...
				if (!params.border){
					params.modul.addClass("wpnw-border-none");
				}

				if (params.fontstyle=="italic"){
					params.modul.addClass("wpnw-italic");
				}	
				if (params.fontstyle=="bold"){
					params.modul.addClass("wpnw-bold");
				}	
				if (params.fontstyle=="bold-italic"){
					params.modul.addClass("wpnw-bold wpnw-italic");
				}
				...
				function resizeEvent() {
					if (params.modul.width()<480){
						...
						params.modul.find("ul").css({"left":$(params.modul).find(".wpos-ticker-title").width()+20});
					}
				}

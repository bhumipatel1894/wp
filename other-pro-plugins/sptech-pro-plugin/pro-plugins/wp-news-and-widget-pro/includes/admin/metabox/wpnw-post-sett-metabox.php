	...
	<tbody>
		...
		<tr valign="top">
			...
			<td>
				...
				<span class="description"><?php _e('If you have different URL then enter read more link for post or Leave empty for current post URL. e.g https://www.wponlinesupport.com', 'sp-news-and-widget'); ?></span>
			</td>
		</tr>

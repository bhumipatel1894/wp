...
function wpnw_pro_register_design_page() {
	add_submenu_page( 'edit.php?post_type='.WPNW_PRO_POST_TYPE, __('How it works, our plugins and offers', 'sp-news-and-widget'), __('How It Works', 'sp-news-and-widget'), 'manage_options', 'wpnw-pro-designs', 'wpnw_pro_designs_page' );
}
	...
	<div class="wrap wpnw-wrap">
		...
		<?php
			if( isset($active_tab) && $active_tab == 'how-it-work' ) {
				...
				echo wpnw_pro_get_plugin_design( 'plugins-feed' );
			} else {
				echo wpnw_pro_get_plugin_design( 'offers-feed' );
			}
		?>
 ...
 * @since 2.0.3
 */
function wpnw_pro_get_plugin_design( $feed_type = '' ) {
	...
	$wpos_feed_tabs = wpnw_pro_help_tabs();
	$transient_key 	= isset($wpos_feed_tabs[$active_tab]['transient_key']) 	? $wpos_feed_tabs[$active_tab]['transient_key'] 	: 'wpnw_' . $active_tab;
								...
								<div class="inside">
									<table class="form-table">
										<tbody>
											<tr>
												<th>
													<label><?php _e('Getting Started with News and widget pro', 'sp-news-and-widget'); ?>:</label>
												</th>
												<td>
													<ul>
											...
											<tr>
												...
												<td>
													<span class="wpnw-shortcode-preview">[sp_news]</span> – <?php _e('News in List View', 'sp-news-and-widget'); ?> <br />
													<span class="wpnw-shortcode-preview">[sp_news_slider]</span> – <?php _e('Display News in Slider View', 'sp-news-and-widget'); ?> <br />
													<span class="wpnw-shortcode-preview">[wpnw_news_ticker]</span> – <?php _e('Display News in Ticker Mode', 'sp-news-and-widget'); ?> <br />
												</td>
											</tr>
										</tbody>
									</table>
						...
						<div class="meta-box-sortables ui-sortable">
							<div class="postbox" style="">
								...
								<div class="inside">
									...
									<a class="button button-primary wpos-button-full" href="https://www.wponlinesupport.com/pro-plugin-document/document-wp-news-and-scrolling-widgets-pro/?utm_source=hp&event=doc" target="_blank"><?php _e('Documentation', 'sp-news-and-widget'); ?></a>	
									<p><a class="button button-primary wpos-button-full" href="http://demo.wponlinesupport.com/prodemo/news-plugin-pro/?utm_source=hp&event=pro_demo" target="_blank"><?php _e('View PRO Designs ', 'sp-news-and-widget'); ?></a>			</p>								
								</div><!-- .inside -->
							</div><!-- #general -->
						</div><!-- .meta-box-sortables ui-sortable -->
					</div><!-- .metabox-holder -->
					...
					<div class="metabox-holder">
						<div class="meta-box-sortables ui-sortable">
							<div class="postbox">
									...
									<div class="inside">
										<p><?php _e('Enjoyed this plugin? You can help by rate this plugin', 'sp-news-and-widget'); ?> <a href="https://www.wponlinesupport.com/your-feedback/?utm_source=hp" target="_blank">5 stars!</a></p>
									</div><!-- .inside -->
							</div><!-- #general -->
						</div><!-- .meta-box-sortables ui-sortable -->
					</div><!-- .metabox-holder -->

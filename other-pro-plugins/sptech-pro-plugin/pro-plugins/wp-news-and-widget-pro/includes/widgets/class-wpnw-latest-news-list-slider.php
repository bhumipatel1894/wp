...
function wpnw_pro_latest_news_list_slider_widget() {
    register_widget( 'Wpnw_Pro_Lnlsw_Widget' );
}

// Action to register widget
add_action( 'widgets_init', 'wpnw_pro_latest_news_list_slider_widget' );
...
class Wpnw_Pro_Lnlsw_Widget extends WP_Widget {
    ...
    */
    function __construct() {
        ...
        parent::__construct( 'sp_newslistpro_widget', __('Latest News List/Slider 1', 'sp-news-and-widget'), $widget_ops );
    }
    ...
    */
    ...
    ?>
        <div class="wpnw-pro-news-widget-wrp wpnaw-clearfix">
            <div class="wpnw-pro-news-slider-widget <?php echo $slider_cls; ?> sp_news_static design-w2 wpnaw-clearfix" id="wpnw-pro-news-slider-widget-<?php echo $unique; ?>">

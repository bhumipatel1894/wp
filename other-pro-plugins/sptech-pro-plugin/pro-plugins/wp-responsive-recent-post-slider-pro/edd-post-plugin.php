...
if( !defined( 'WPRPSP_LICENSE_URL' ) ) {
	define( 'WPRPSP_LICENSE_URL', add_query_arg(array('page' => 'postpro-license'), admin_url('edit.php')) );
}
...
function wprpsp_plugin_license_menu() {
	...
	add_submenu_page( 'edit.php', __('Post Slider Plugin License', 'wp-responsive-recent-post-slider'), __('Post Slider Plugin License', 'wp-responsive-recent-post-slider').$notification, 'manage_options', 'postpro-license', 'wprpsp_plugin_license_page' );
}
...
?>
	<div class="wrap">
		<h2><?php _e('Post Slider Plugin License Options', 'wp-responsive-recent-post-slider'); ?></h2>
				...
				<tbody>
					<tr valign="top">
						...
						<td>
							...
							<span class="description"><?php _e('Enter your license key.', 'wp-responsive-recent-post-slider'); ?></span>
						</td>
					</tr>

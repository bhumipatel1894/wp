...
class Wprpsp_Admin {
	...
	function wprpsp_post_sett_metabox() {
		...
		add_meta_box( 'wprpsp-post-sett', __( 'WP Responsive Recent Post Slider Pro - Settings', 'wp-responsive-recent-post-slider' ), array($this, 'wprpsp_post_sett_mb_content'), $supported_post_types, 'normal', 'high' );
	}

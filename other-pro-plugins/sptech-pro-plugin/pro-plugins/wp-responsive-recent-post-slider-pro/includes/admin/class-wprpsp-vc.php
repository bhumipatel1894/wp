			...
			'params' 	=> array(
								...
								array(
									...
									'value' 		=> array(
															...
															__( 'Slider Design 27', 'wp-responsive-recent-post-slider' ) 	=> 'design-27',
															__( 'Slider Design 28', 'wp-responsive-recent-post-slider' ) 	=> 'design-28',
															__( 'Slider Design 29', 'wp-responsive-recent-post-slider' ) 	=> 'design-29',
															__( 'Slider Design 30', 'wp-responsive-recent-post-slider' ) 	=> 'design-30',
														),
								...
								array(
									...
									'value' 		=> 'post',
									'description' 	=> __( 'Enter registered post type name. You can find it on plugin setting page.', 'wp-responsive-recent-post-slider' ),
								...
								array(
									...
									'param_name' 	=> 'taxonomy',
									'value' 		=> 'category',
									'description' 	=> __( 'Enter registered taxonomy name. You can find it on plugin setting page.', 'wp-responsive-recent-post-slider' ),
									'group' 		=> __( 'Data Settings', 'wp-responsive-recent-post-slider' ),
								),
								array(
									'type' 			=> 'textfield',

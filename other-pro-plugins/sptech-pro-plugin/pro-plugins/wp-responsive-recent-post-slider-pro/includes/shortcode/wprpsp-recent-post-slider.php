...
function wprpsp_recent_post_slider( $atts, $content = null ) {
	...
	$slider_height			= (empty($slider_height) && ($design == 'design-27' || $design == 'design-28')) ? '500' : $slider_height;
			...
			if( in_array( $design, $nav_designs) ) { ?>
				...
				?>
					<div class="wprpsp-post-nav-loop">
						...
						<span class="block-right-content">
							<?php echo wprpsp_limit_words( get_the_title(), 6 ); ?>

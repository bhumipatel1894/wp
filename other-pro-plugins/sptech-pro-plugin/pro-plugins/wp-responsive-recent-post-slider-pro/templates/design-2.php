	...
	<div class="wprpsp-post-cnt-pos">
		<div class="wprpsp-post-cnt-left wprpsp-medium-6 wprpsp-columns">
			...
			<?php } ?>
		  	...
		  	<h2 class="wprpsp-post-title"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
			...
			<?php if($showContent == "true") { ?>
				<div class="wprpsp-post-content">
					...
					<a class="wprpsp-read-more-btn" href="<?php the_permalink(); ?>"><?php esc_html_e($read_more_text); ?></a>
					<?php } ?>
				</div>
			<?php } ?>
		</div>

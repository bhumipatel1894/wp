...
<table class="form-table wpsisac-post-sett-table">
	<tbody>
		<tr valign="top">
			...
			<td>
				<input type="url" value="<?php echo esc_url($read_more_link); ?>" class="large-text wpsisac-more-link" id="wpsisac-more-link" name="<?php echo $prefix; ?>more_link" /><br/>
				<span class="description"><?php _e('Enter read more link. eg. http://wponlinesupport.com', 'wp-slick-slider-and-image-carousel'); ?></span>
			</td>
		</tr>
	</tbody>

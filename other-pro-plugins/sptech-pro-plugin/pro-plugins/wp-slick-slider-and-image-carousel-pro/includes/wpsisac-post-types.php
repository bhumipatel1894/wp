...
function wpsisac_pro_register_post_type() {
	...
	$wpsisac_pro_slider_args = array(
		...
		'supports'            	=> apply_filters('wpsisac_pro_post_supports', array('title', 'editor', 'thumbnail', 'page-attributes')),
	);
...
function wpsisac_pro_post_updated_messages( $messages ) {
	...
	$messages[WPSISAC_PRO_POST_TYPE] = array(
		...
		9 => sprintf( __( 'Slider scheduled for: <strong>%1$s</strong>.', 'wp-slick-slider-and-image-carousel' ),

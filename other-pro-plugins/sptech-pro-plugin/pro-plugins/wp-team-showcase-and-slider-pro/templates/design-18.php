<div class="<?php echo $class.' '.$css_class;?>" <?php echo $style_offset;?>>
	...
	<div class="wp-tsasp-team-item wp-tsasp-team-box wp-tsasp-box-effect wp-tsasp-left-right">
		<div class="wp-tsasp-teambox-img wp-tsasp-team-avatar-bg">
			<?php if( $teamfeat_image ) { ?>
				<img class="wp-tsasp-team-avatar" src="<?php echo $teamfeat_image; ?>" alt="<?php the_title(); ?>" />
			<?php } ?>
		</div>

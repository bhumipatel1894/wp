	...
	<div class="wp-tsasp-team-member">
		...
		<div class="wp-tsasp-team-img wp-tsasp-team-avatar-bg">
			...
			<div class="wp-tsasp-link-outer">
				<a class="wp-tsasp-popup-link" href="javascript:void(0);" data-mfp-src="#popup-<?php echo $popup_id; ?>"><i class="fa fa-info"></i></a>
			</div>
			<?php } ?>
		</div>
		...
		<div class="wp-tsasp-team-detail">
			...
			<span class="wp-tsasp-team-name"><?php the_title(); ?></span><br />

			<?php if($member_designation != '' || $member_department != '') { ?>
			<span class="wp-tsasp-team-data">
				<?php

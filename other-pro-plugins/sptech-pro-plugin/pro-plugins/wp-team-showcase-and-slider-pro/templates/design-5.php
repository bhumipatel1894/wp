<div class="<?php echo $class.' '.$css_class;?>" <?php echo $style_offset;?>>
	...
	<div class="wp-tsasp-team-member">
		...
		<div class="wp-tsasp-team-img wp-tsasp-team-avatar-bg">
			...
			<?php $wp_tsasp_member_social_meta = wp_tsasp_member_social_meta($post->ID, $social_limit);
			if (!empty($wp_tsasp_member_social_meta)) { ?>
			<div class="overlay"><?php echo $wp_tsasp_member_social_meta; ?></div>
			<?php } ?>

			<?php if($popup == 'true') { ?>
			<a class="wp-tsasp-team-info-icon wp-tsasp-popup-link" href="javascript:void(0);" data-mfp-src="#popup-<?php echo $popup_id; ?>"></a><?php
		} ?>
	</div>
